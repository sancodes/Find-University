...
<div id="gm">
    ...
    API used: 
    [link](http://universities.hipolabs.com/search?country= + {country name})
    ...
    <ul>
        ...
        <ul>
            <li> <strong>Model</strong>: Salesforce Data Model
                <ul>
                    <li> Data model is simple and contains single schema and will save and retrieve data from Salesforce
                        Database </li>
                </ul>
                <br>
            ...
            <li> <strong>Controller</strong>: JavaScript and Apex
                <ul>
                    ...
                    <li> JavaScript controller is responsible for passing the user input from front end to the backend
                        Apex and also data binding to the Aura. Apex is responsible for fetching API via HTTP request
